  ...
  spiderMenu: [
    {
      ...
      angle: -90,
      children: [
        { label: "Vehículos",            icon: "🚗", href: "#vehicular" },
        { label: "Hogar",                icon: "🏠", href: "#contacto"  },
        { label: "Vida y\nAs. Médica",   icon: "❤️", href: "#vida"      },
